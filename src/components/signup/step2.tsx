...
export default function Step2({ onNext }: Props) {
	...
	const isValid = nickname && birth && email && password && confirm && password === confirm;
	...
	return (
		<div className="w-full max-w-md flex flex-col gap-4 items-start justify-center">
			...
			<div className="w-full flex items-center justify-center gap-2">
				<TextField placeholder="생년월일" variant="signup" value={birth} onChange={() => { }} />
				<Button width="w-auto" onClick={openModal}><Calendar size={20} /></Button>
			</div>
