...
export default function Modal({ children, onClose }: ModalProps) {
	...
	return ReactDOM.createPortal(
		...
		bg-black bg-opacity-50 p-6 rounded-lg shadow-lg">
			<div className="relative top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-lg
			shadow-lg w-[300px] flex flex-col items-center justify-center gap-2">
				<button
					onClick={onClose}
